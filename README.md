...
<body>  <div class="wrap">  
  ...
  </section>    <section class="fighters">  
...
</div>  <!-- Modals -->  <div id="courses" class="modal"><div class="modal-content"><button class="close">Close</button><h3>Courses & Tutorials</h3>  
<ul>  
...
</ul></div></div>  <div id="helpline" class="modal"><div class="modal-content"><button class="close">Close</button><h3>National Helpline</h3>  
<ul>  
...
</ul></div></div>  <div id="jobs" class="modal"><div class="modal-content"><button class="close">Close</button><h3>Job Portals</h3>  
<ul>  
