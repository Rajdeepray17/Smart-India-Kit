...
<body>  
  <div class="wrap">  
    ...
    <section class="sections">  
      ...
      <div class="card" data-modal="learning-platforms">  
        <h2>4) Learning Platforms</h2>  
        <p>Popular platforms for language learning, coding, and diverse courses.</p>  
      </div>
      <div class="card" data-modal="educational-resources">  
        <h2>5) Educational Resources</h2>  
        <p>Science, math, and general education resources for all ages.</p>  
      </div>  
      <div class="card" data-modal="skill-development">  
        <h2>6) Skill Development</h2>  
        <p>Platforms offering professional and creative skill enhancement.</p>  
      </div>  
      <div class="card" data-modal="other-resources">  
  ...
  <div id="courses" class="modal">
    <div class="modal-content">
      ...
      <ul>  
        ...
        <li><a href="https://edx.org" target="_blank">edX</a></li>
        <li><a href="https://khanacademy.org" target="_blank">Khan Academy</a></li>
        <li><a href="https://open.edu/openlearn" target="_blank">OpenLearn</a></li>
  ...
  <div id="learning-platforms" class="modal">
    <div class="modal-content">
      ...
      <ul>
        <li><a href="https://duolingo.com" target="_blank">Duolingo</a> - Language learning</li>
        <li><a href="https://codecademy.com" target="_blank">Codecademy</a> - Coding</li>
        <li><a href="https://udemy.com" target="_blank">Udemy</a> - Various courses</li>
      </ul>
    </div>
  </div>
  <div id="educational-resources" class="modal">
    <div class="modal-content">
      ...
      <ul>
        <li><a href="https://kids.nationalgeographic.com" target="_blank">National Geographic Kids</a> - Learning resources</li>
        <li><a href="https://nasa.gov/stem" target="_blank">NASA STEM Resources</a> - Science and math resources</li>
        <li><a href="https://bbc.co.uk/learning" target="_blank">BBC Learning</a> - Educational content</li>
      </ul>
    </div>
  </div>
  <div id="skill-development" class="modal">
    <div class="modal-content">
      ...
      <ul>
        <li><a href="https://linkedin.com/learning" target="_blank">LinkedIn Learning</a> - Professional development</li>
        <li><a href="https://skillshare.com" target="_blank">Skillshare</a> - Creative skills</li>
        <li><a href="https://freecodecamp.org" target="_blank">FreeCodeCamp</a> - Coding</li>
      </ul>
    </div>
  </div>
